...
- get_off_periods to list the user's vacation / sick / holiday / personal time-off periods. Use when answering "am I off next week?", "when's my next vacation?", or whenever a schedule answer should account for time off. Past periods are excluded by default.
